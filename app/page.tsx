    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-8">
        ...
        <div className="text-center mb-6 md:mb-8 animate-fade-in">
          <div className="inline-block relative">
            ...
            <div className="relative bg-amber-950 rounded-lg px-4 sm:px-6 md:px-8 py-3 md:py-4 ring-1 ring-amber-900/5">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-amber-200 mt-1 md:mt-2">& Glamps</p>
            </div>
          </div>
        </div>
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-amber-100 mb-8 md:mb-12 text-center max-w-xs sm:max-w-md md:max-w-2xl animate-fade-in-delay px-2">
          Experience nature like never before. Your eco-luxury escape awaits in the heart of wilderness.
        </p>
          ...
          {Object.entries(timeLeft).map(([unit, value]) => (
            <div key={unit} className="timer-box">
              <div className="bg-amber-900/30 backdrop-blur-sm rounded-lg p-3 sm:p-4 md:p-6 border border-amber-700/50 hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-xs sm:text-sm md:text-base text-amber-300 capitalize">{unit}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-12 max-w-xs sm:max-w-2xl md:max-w-4xl w-full">
          <div className="feature-card group">
            <div className="bg-amber-900/20 backdrop-blur-sm rounded-lg p-4 sm:p-5 md:p-6 border border-amber-700/30 hover:border-amber-500/50 transition-all duration-300 hover:transform hover:-translate-y-1">
              ...
              <h3 className="text-base md:text-lg font-semibold text-amber-200 mb-1 md:mb-2">Mud Houses</h3>
              <p className="text-amber-100/80 text-xs md:text-sm">Traditional eco-friendly accommodations with modern comfort</p>
            </div>
          </div>
          <div className="feature-card group">
            <div className="bg-amber-900/20 backdrop-blur-sm rounded-lg p-4 sm:p-5 md:p-6 border border-amber-700/30 hover:border-amber-500/50 transition-all duration-300 hover:transform hover:-translate-y-1">
              <div className="text-3xl md:text-4xl mb-2 md:mb-3">⛺</div>
              <h3 className="text-base md:text-lg font-semibold text-amber-200 mb-1 md:mb-2">Glamping</h3>
              <p className="text-amber-100/80 text-xs md:text-sm">Luxury camping experience under the stars</p>
            </div>
          </div>
          <div className="feature-card group">
            <div className="bg-amber-900/20 backdrop-blur-sm rounded-lg p-4 sm:p-5 md:p-6 border border-amber-700/30 hover:border-amber-500/50 transition-all duration-300 hover:transform hover:-translate-y-1 sm:col-span-2 md:col-span-1">
              <div className="text-3xl md:text-4xl mb-2 md:mb-3">🌿</div>
              <h3 className="text-base md:text-lg font-semibold text-amber-200 mb-1 md:mb-2">Nature Activities</h3>
              <p className="text-amber-100/80 text-xs md:text-sm">Guided tours, hiking, and wildlife experiences</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-4 sm:gap-6 mt-8 md:mt-12">
          <a href="https://www.facebook.com/monkeymudhostel" target="_blank" rel="noopener noreferrer" className="text-amber-300 hover:text-amber-100 transition-colors duration-300 transform hover:scale-110">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          </a>
          <a href="https://www.instagram.com/monkeymudhouse/" target="_blank" rel="noopener noreferrer" className="text-amber-300 hover:text-amber-100 transition-colors duration-300 transform hover:scale-110">
